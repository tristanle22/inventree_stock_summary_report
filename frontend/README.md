# Stock Summary Report- Frontend Code

This directory contains the frontend code for the Stock Summary Report plugin.
...
This will compile the frontend into the `../stock_summary_report/static` directory (ready for distribution).
