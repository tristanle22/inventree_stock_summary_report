 ...
 */
function StockSummaryReportPanel({
    context
}: {
    ...
    return (
        ...
        {editPartForm.modal}
        <Stack gap="xs">
        <Title order={3}>Stock Summary Report</Title>
        <Text>
            This is a custom panel for the StockSummaryReport plugin.
        </Text>
...
export function renderStockSummaryReportPanel(context: InvenTreePluginContext) {
    checkPluginVersion(context);
    return <StockSummaryReportPanel context={context} />;
}